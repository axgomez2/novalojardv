<x-admin-layout>
    <div class="mb-8">
        ...
        <h1 class="mt-2 text-2xl font-bold text-gray-900">Nova Gravadora</h1>
    </div>

    <div class="mx-auto max-w-2xl">
        <form method="POST" action="{{ route('admin.settings.record-labels.store') }}" class="rounded-lg bg-white p-6 shadow">
            @csrf
            <div class="space-y-6">
                <div>
