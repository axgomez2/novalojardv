<x-admin-layout>
    <div class="mb-8">
        ...
        <h1 class="mt-2 text-2xl font-bold text-gray-900">Editar Origem de Receita</h1>
    </div>

    <form method="POST" action="{{ route('admin.financial.income-sources.update', $source) }}" class="space-y-6">
        @csrf
        @method('PUT')
        <div class="rounded-lg bg-white p-6 shadow">
            <div class="grid gap-4 sm:grid-cols-2">
                ...
                <div>
                    ...
                    <input type="color" name="color" id="color" value="{{ old('color', $source->color) }}" required
                ...
                <div class="sm:col-span-2">
                    ...
                    <textarea name="description" id="description" rows="2"
                              class="mt-1 block w-full rounded-lg border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500">{{ old('description', $source->description) }}</textarea>
                </div>
